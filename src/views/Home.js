...
function Home() {
    const { today, workouts, setWorkouts, selectedItem, setSelectedItem, appRef } = useContext(GlobalContext);
    ...
    return (
        ...
        <div className="mainScreen-container">
            ...
            <div className='header'>
                ...
                <NavLink to='CreateNewProgram' className='createNewBtn ml-auto headerCreateProgram'>
            ...
            <div className="grid gap-3">
                ...
                <div className="otherProgramsContainer">
                    <div className="slider">
                        <NavLink to='CreateNewProgram' className="createNewBtn createNewProgram">
